(() => {
  ...
  function startUpdate() {
    ...
    if (!api || !api.start_update) {
      toast3("\u5F53\u524D\u73AF\u5883\u4E0D\u652F\u6301\u81EA\u52A8\u66F4\u65B0", "error");
      return;
    }
    var tag = _pendingTag;
    if (!tag) {
      toast3("\u7F3A\u5C11\u76EE\u6807\u7248\u672C\u4FE1\u606F\uFF0C\u8BF7\u7A0D\u540E\u91CD\u8BD5", "error");
      return;
    }
    _updateBusy = true;
    setUpdStatus("", "");
  ...
  function _notifyUpdateResult() {
    var api = getApi();
    if (!api || !api.consume_update_result) return;
    api.consume_update_result().then(function(r) {
      if (!r || typeof r !== "object") return;
      if (r.updated) {
        toast3("\u5DF2\u66F4\u65B0\u5230 " + (r.version || "\u65B0\u7248\u672C"), "success");
      } else if (r.failed) {
        toast3("\u81EA\u52A8\u66F4\u65B0\u5931\u8D25\uFF1A" + (r.error || "\u672A\u77E5\u9519\u8BEF"), "error");
      }
    }).catch(function(e) {
